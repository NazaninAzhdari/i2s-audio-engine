...
### **UART_RX (Universal Asynchronous Receiver/Transmitter)**
...
### **melody_pack**
This is a VHDL package that provides a specialized data type called `t_tone_array`. This array allows the system to store a flexible list of tone frequencies, making it easier to manage the "library" of sounds the engine can produce.
...
It serializes the 24-bit samples into a continuous stream of data for the audio hardware.  
