package melody_pack is
    ...
    constant c_police     :   t_tone_array   
    :=(
    ...
    constant c_ambulance     :   t_tone_array   
    :=(
    ...
    constant c_elephant     :   t_tone_array   
    :=(
    ...
    constant c_robat_talking     :   t_tone_array   
    :=(
    ...
    -- Number of Tones :  "32"
    -- Duration per tone: ~41 ms, corrospond to "2000" clocks (with 48KHz clock)
    constant c_retro_start     :   t_tone_array   
    :=(
    ...
    -- Number of Tones :  "28"
    -- Duration per tone: ~31 ms, corrospond to "1500" clocks (with 48KHz clock)
    constant c_retro_menu     :   t_tone_array   
    :=(
    ...
    constant c_harsh_alarm     :   t_tone_array   
    :=(
    ...
    -- Number of Tones :  "32"
    -- Duration per tone: ~41 ms, corrospond to "2000" clocks (with 48KHz clock)
    constant c_wired_alarm     :   t_tone_array   
    :=(
    ...
    constant c_horror_siren     :   t_tone_array   
    :=(
    ...
    -- Number of Tones :  "36"
    -- Duration per tone: ~62 ms, corrospond to "3000" clocks (with 48KHz clock)
    constant c_robatic     :   t_tone_array   
    :=(
        24,48,24,48,
        30,60,30,60,
        20,40,20,40,
    ...
    -- Number of Tones :  "48"
    -- Duration per tone: ~83 ms, corrospond to "4000" clocks (with 48KHz clock)
    constant c_rising     :   t_tone_array   
    :=(
    ...
    constant c_expand_contract     :   t_tone_array   
    :=(
